    ...
    return(
      ...
      <main className="flex flex-1 py-16 bg-[var(--background-soft)]">
        ...
        <div className="hidden lg:flex flex-1 max-w-lg">
            ...
            <form className="flex gap-6 flex-col w-full max-w-lg bg-[var(--surface)] shadow-[var(--shadow-lg)] rounded-2xl py-8 px-12">
                <div>
                ...
                <div className="flex flex-col">
                    ...
                    <input className="w-full rounded-lg border border-[var(--border)] bg-white px-4 py-3 text-[var(--text-primary)] placeholder:text-[var(--text-muted)] focus:outline-none focus:border-[var(--accent)] focus:ring-2 focus:ring-[var(--accent)]/20 focus:shadow-[var(--shadow-sm)] transition-all duration-200" type="email" id="userEmail" name="email" placeholder="chefcurry01@gmail.com"/>
                ...
                <div className="mt-6">
                    <button className="flex w-full items-center justify-center gap-3 rounded-lg border border-[var(--border)] bg-[var(--accent)] px-4 py-3 text-sm font-medium text-white shadow-[var(--shadow-sm)] transition-colors duration-200 hover:bg-[var(--background-soft)] hover:text-[var(--text-primary)] focus:outline-none cursor-pointer">Create Account</button>
                </div>
                <p className="text-center">Already have an account? <span className="underline text-[var(--accent)]">Log In</span></p>
            </form>
        </div>
      </main>
      </div>
